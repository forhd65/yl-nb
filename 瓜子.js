...
var rule = {
    ...
    lazy: $js.toString(() => {
        ...
        input = { parse: 0, url: url, header: {"User-Agent":"Lavf/57.83.100"} }
        setResult(d)
    }),
    //   推荐: $js.toString(() => {
    //     let d = [];
